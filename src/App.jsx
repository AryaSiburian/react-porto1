  ...
  <>
      <div className="hero grid md:grid-cols-2 items-center pt-10 xl:gap-0 gap-6 grid-cols-1">
        <div>
         ...
         <img src={`${import.meta.env.BASE_URL}assets/profile.jpg`} alt='picture'        
         className="w-[500px] md:ml-auto rounded-4xl" laoding="lazy" />
      </div>
      ...
      <div className="tools mt-32">
        ...
        <p className="xl:w-2/5 lg:w-2/4 md:w-2/3 sm:w-3/4 text-base/loose opacity-50">Berikut ada tools yg saya pakai untuk
      ...
      <h1 className="text-4xl mb-8 font-bold text-center">Kontak</h1>
      <p className="text-base text-center mb-10 opacity-50">Mari Terhubung Dengan Saya.</p>
